...
```
**Important:** Set these in your Vercel project dashboard under "Settings" → "Environment Variables". Do NOT use secrets for any of these variables - set them as regular environment variables.
---
